describe("Task Action Buttons", () => {
  describe("Based on the state of the task, some buttons should be disabled and others should be clickable. Clicking on buttons produces banners messaging if the action succeeded or failed.", () => {
    ...
    it("Clicking Unschedule button should unschedule a task and display an error toast", () => {
      cy.visit(tasks[6]);
      cy.dataCy("ellipsis-btn").click();
      cy.dataCy("card-dropdown").should("be.visible");
      cy.dataCy("unschedule-task").click();
      cy.validateToast("error", unscheduleFailureBannerText);
    });
...
const unscheduleFailureBannerText =
  "Error unscheduling task: updating build and version status for task 'evergreen_ubuntu1604_otter_repotracker_5e823e1f28baeaa22ae00823d83e03082cd148ab_20_02_20_20_37_06': no build 'evergreen_ubuntu1604_5e823e1f28baeaa22ae00823d83e03082cd148ab_20_02_20_20_37_06' found for task 'evergreen_ubuntu1604_otter_repotracker_5e823e1f28baeaa22ae00823d83e03082cd148ab_20_02_20_20_37_06'";
...
const tasks = {
  ...
  6: "/task/evergreen_ubuntu1604_otter_repotracker_5e823e1f28baeaa22ae00823d83e03082cd148ab_20_02_20_20_37_06",
};
