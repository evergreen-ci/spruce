...
describe("getLimitFromSearch", () => {
  ...
  test("should return the value of the 'limit' query variable from the given search string if it is a valid page size.", () => {
  ...
  test("should return the recent page size value in local storage when the value in local storage is a valid page size and the given search string does not contain a valid limit,", () => {
