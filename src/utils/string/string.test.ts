...
describe("getDateCopy", () => {
  it("converts strings to a date with no options", () => {
    expect(getDateCopy("08/31/1996")).toBe("Aug 31, 1996, 12:00:00 AM GMT+0");
    expect(getDateCopy("12-23-2014")).toBe("Dec 23, 2014, 12:00:00 AM GMT+0");
    expect(getDateCopy("2020-11-16T22:17:29")).toBe(
      "Nov 16, 2020, 10:17:29 PM GMT+0"
    );
  });
