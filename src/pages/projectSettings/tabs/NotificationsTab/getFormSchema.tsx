...
import { getFormSchema as getNotificationSchema } from "components/Notifications/getFormSchema";
import { SpruceFormProps } from "components/SpruceForm";
import { CardFieldTemplate } from "components/SpruceForm/FieldTemplates";
import widgets from "components/SpruceForm/Widgets";
import {
  projectTriggers,
  projectSubscriptionMethods as subscriptionMethods,
      ...
      subscriptions: {
        ...
        items: {
          ...
          properties: {
            subscription: {
              title: "",
              ...getNotificationSchema([], projectTriggers, subscriptionMethods)
                .schema,
            },
