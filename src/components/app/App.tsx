...
export class Evergreen extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const config = () => (
      <ConfigDrop
        updateClientConfig={this.updateConfig}
        onLoadFinished={null}
      />
    );
                ...
                <HashRouter>
                  <AppBar className="app-bar">
                    <Toolbar>
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/waterfall"}
                        underline="none"
                      >
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/timeline"}
                        underline="none"
                      >
                        <Typography noWrap={true} className="menu-option">
                          Timeline
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/grid"}
                        underline="none"
                      >
                        <Typography noWrap={true} className="menu-option">
                          Summary
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/patches"}
                        underline="none"
                      >
                        <Typography noWrap={true} className="menu-option">
                          Patches
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/task_timing"}
                        underline="none"
                      >
                        <Typography noWrap={true} className="menu-option">
                          Stats
                      ...
                      <Link
                        href={this.state.APIClient.uiURL + "/hosts"}
                        underline="none"
                      >
                        <Typography noWrap={true} className="menu-option">
                          Hosts
                      ...
                      <Menu
                        ...
                        anchorEl={this.state.PluginMenuAnchor}
                        anchorOrigin={{
                          vertical: "bottom",
                          horizontal: "center"
                        }}
                      ...
                      >
                        <MenuItem onClick={this.closePluginMenu}>
                          <Link
                            href={this.state.APIClient.uiURL + "/perfdiscovery"}
                            underline="none"
                          >
                        ...
                        <MenuItem onClick={this.closePluginMenu}>
                          <Link
                            href={this.state.APIClient.uiURL + "/perf-bb"}
                            underline="none"
                          >
                            <Typography noWrap={true}>
                              Performance Baron
