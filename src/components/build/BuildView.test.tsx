...
describe("BuildView", () => {
  ...
  it("BuildView was constructed correctly", () => {
    ...
    expect(buildView.state("buildId")).toBe(
      "spruce_ubuntu1604_compile_patch_e44b6da8831497cdd4621daf4c62985f0c1c9ca9_5d28cfa05623434037b0294c_19_07_12_18_21_22"
    );
  ...
  it("clicking LogContainer toggle button changes state", () => {
    ...
    const allButton = buttonGroup
      .find({ value: LogType.all })
      .find(ToggleButton);
  ...
  it("clicking on task panel loads new logs and updates state", done => {
    ...
    const buildPromise = mockClient
      .getBuild("someId")
      .then((resp: AxiosResponse<any>) => {
        build = ConvertToBuild(resp.data);
      });
    const taskPromise = mockClient
      .getTasksForBuild("someId")
      .then((resp: AxiosResponse<any>) => {
    ...
    Promise.all([buildPromise, taskPromise]).then(() => {
      const buildSidebar = enzyme.mount(
        <BuildSidebar
          client={mockClient}
          build={build}
          tasks={tasks}
      ...
      expect(buildSidebar).toHaveLength(1);
      expect(buildSidebar.prop("currentTask").task_id).toBe(
        "spruce_ubuntu1604_compile_patch_e44b6da8831497cdd4621daf4c62985f0c1c9ca9_5d28cfa05623434037b0294c_19_07_12_18_21_22"
      );
      const compilePanel = buildSidebar
        .findWhere(
          node =>
            node.key() ===
            "spruce_ubuntu1604_compile_patch_e44b6da8831497cdd4621daf4c62985f0c1c9ca9_5d28cfa05623434037b0294c_19_07_12_18_21_22"
      ...
      const checkState = jest.fn(() => {
        ...
        const checkTestPanel = buildSidebar
          .findWhere(
            node =>
              node.key() ===
              "spruce_ubuntu1604_test_patch_e44b6da8831497cdd4621daf4c62985f0c1c9ca9_5d28cfa05623434037b0294c_19_07_12_18_21_22"
        ...
        const checkCompilePanel = buildSidebar
          .findWhere(
            node =>
              node.key() ===
              "spruce_ubuntu1604_compile_patch_e44b6da8831497cdd4621daf4c62985f0c1c9ca9_5d28cfa05623434037b0294c_19_07_12_18_21_22"
