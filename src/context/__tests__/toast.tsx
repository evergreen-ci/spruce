 ...
 * @returns {Object} response.dispatchToast.success - A jest.fn() method which can be used to assert that the success toast context was called
 * @returns {Object} response.dispatchToast.error - A jest.fn() method which can be used to assert that the error toast context was called
 * @returns {Object} response.dispatchToast.info - A jest.fn() method which can be used to assert that the info toast context was called
 * @returns {Object} response.dispatchToast.warning - A jest.fn() method which can be used to assert that the warning toast context was called
 * @returns {Object} response.dispatchToast.hide - A jest.fn() method which can be used to assert that the hide toast context was called
