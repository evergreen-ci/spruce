...
export type GetTaskEventDataQuery = { task?: Maybe<{ id: string, status: string, failedTestCount: number }> };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, status: string, baseStatus?: Maybe<string>, displayName: string, buildVariant: string, blocked: boolean, executionTasksFull?: Maybe<Array<{ id: string, displayName: string, status: string, buildVariant: string, baseStatus?: Maybe<string> }>> }> } };
...
export type GetTaskAllExecutionsQuery = { taskAllExecutions: Array<{ execution?: Maybe<number>, status: string, ingestTime?: Maybe<Date>, activatedTime?: Maybe<Date> }> };
...
export type GetTaskLatestExecutionQuery = { task?: Maybe<{ id: string, latestExecution: number }> };
...
export type GetSpawnTaskQuery = { task?: Maybe<{ id: string, displayName: string, buildVariant: string, revision?: Maybe<string>, project?: Maybe<{ spawnHostScriptPath: string }> }> };
