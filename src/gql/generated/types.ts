...
export type EditSpawnHostMutation = { editSpawnHost: { id: string, displayName?: Maybe<string>, status: string, instanceType?: Maybe<string>, noExpiration: boolean, expiration?: Maybe<Date>, instanceTags: Array<{ key?: Maybe<string>, value?: Maybe<string>, canBeModified?: Maybe<boolean> }>, volumes: Array<{ displayName: string, id: string }> } };
...
export type PatchBuildVariantsQuery = { patchBuildVariants: Array<{ variant: string, displayName: string, tasks?: Maybe<Array<Maybe<{ id: string, name: string, status: string }>>> }> };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, status: string, baseStatus: string, displayName: string, buildVariant: string, blocked: boolean }> } };
...
export type GetTaskQuery = { taskFiles: { fileCount: number }, task?: Maybe<{ activatedBy?: Maybe<string>, buildVariant: string, ingestTime?: Maybe<Date>, estimatedStart?: Maybe<number>, displayName: string, finishTime?: Maybe<Date>, hostId?: Maybe<string>, patchNumber?: Maybe<number>, startTime?: Maybe<Date>, status: string, timeTaken?: Maybe<number>, version: string, revision?: Maybe<string>, totalTestCount: number, failedTestCount: number, spawnHostLink?: Maybe<string>, priority?: Maybe<number>, canRestart: boolean, canAbort: boolean, canSchedule: boolean, canUnschedule: boolean, canSetPriority: boolean, ami?: Maybe<string>, distroId: string, latestExecution: number, blocked: boolean, generatedBy?: Maybe<string>, generatedByName?: Maybe<string>, isPerfPluginEnabled: boolean, baseTaskMetadata?: Maybe<{ baseTaskDuration?: Maybe<number>, baseTaskLink: string }>, patchMetadata: { author: string }, reliesOn: Array<{ buildVariant: string, metStatus: MetStatus, name: string, requiredStatus: RequiredStatus, uiLink: string }>, logs: { allLogLink?: Maybe<string>, agentLogLink?: Maybe<string>, systemLogLink?: Maybe<string>, taskLogLink?: Maybe<string>, eventLogLink?: Maybe<string> }, details?: Maybe<{ oomTracker: { detected: boolean, pids?: Maybe<Array<Maybe<number>>> } }> }> };
...
export type TaskQueuePositionQuery = { task?: Maybe<{ minQueuePosition: number }> };
