...
export type DistroTaskQueueQuery = { distroTaskQueue: Array<{ id: string, expectedDuration: number, requester: TaskQueueItemType, displayName: string, project: string, buildVariant: string, priority: number, revision: string }> };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, status: string, baseStatus: string, displayName: string, buildVariant: string }> } };
...
export type GetTaskAllExecutionsQuery = { taskAllExecutions: Array<{ execution?: Maybe<number>, status: string, createTime?: Maybe<Date> }> };
