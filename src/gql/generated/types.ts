...
export type Annotation = {
  ...
  userModifyPermission: Scalars['Boolean'];
};
...
export type CodeChangesQuery = { patch: { id: string, moduleCodeChanges: Array<{ branchName: string, htmlLink: string, rawLink: string, fileDiffs: Array<{ fileName: string, additions: number, deletions: number, diffLink: string }> }> } };
...
export type CommitQueueQuery = { commitQueue: { projectId?: Maybe<string>, message?: Maybe<string>, owner?: Maybe<string>, repo?: Maybe<string>, queue?: Maybe<Array<{ issue?: Maybe<string>, enqueueTime?: Maybe<Date>, patch?: Maybe<{ id: string, author: string, description: string, moduleCodeChanges: Array<{ rawLink: string, branchName: string, htmlLink: string, fileDiffs: Array<{ fileName: string, additions: number, deletions: number, diffLink: string }> }> }> }>> } };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, status: string, baseStatus?: Maybe<string>, displayName: string, buildVariant: string, blocked: boolean }> } };
