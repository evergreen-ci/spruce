...
export type GetTaskEventDataQuery = { task?: Maybe<{ status: string, failedTestCount: number }> };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, aborted: boolean, status: string, baseStatus?: Maybe<string>, displayName: string, buildVariant: string, blocked: boolean }> } };
...
export type GetSpruceConfigQuery = { spruceConfig?: Maybe<{ bannerTheme?: Maybe<string>, banner?: Maybe<string>, ui?: Maybe<{ userVoice?: Maybe<string> }>, jira?: Maybe<{ host?: Maybe<string> }>, providers?: Maybe<{ aws?: Maybe<{ maxVolumeSizePerUser?: Maybe<number> }> }> }> };
...
export type TaskFilesQuery = { taskFiles: { groupedFiles: Array<{ taskName?: Maybe<string>, files?: Maybe<Array<{ name: string, link: string }>> }> } };
...
export type GetTaskLatestExecutionQuery = { task?: Maybe<{ latestExecution: number }> };
...
export type UserPatchesQuery = { userPatches: { filteredPatchCount: number, patches: Array<{ id: string, projectID: string, description: string, status: string, createTime?: Maybe<Date>, commitQueuePosition?: Maybe<number>, canEnqueueToCommitQueue: boolean, builds: Array<{ id: string, buildVariant: string, status: string }> }> } };
...
export type ConfigurePatchQuery = { patch: { id: string, description: string, author: string, alias: string, status: string, activated: boolean, commitQueuePosition?: Maybe<number>, time?: Maybe<{ submittedAt: string }>, project?: Maybe<{ tasks: Array<string>, variants: Array<{ name: string, displayName: string, tasks: Array<string> }> }>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>> } };

export type SpawnExpirationInfoQueryVariables = {};


export type SpawnExpirationInfoQuery = { myHosts: Array<{ noExpiration: boolean, id: string }>, myVolumes: Array<{ noExpiration: boolean, id: string }>, spruceConfig?: Maybe<{ spawnHost: { unexpirableHostsPerUser: number, unexpirableVolumesPerUser: number } }> };
