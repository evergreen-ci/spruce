...
export type GetTaskEventDataQuery = { task?: Maybe<{ id: string, execution: number, status: string, failedTestCount: number }> };
...
export type GetAnnotationEventDataQuery = { task?: Maybe<{ annotation?: Maybe<{ id: string, taskId: string, taskExecution: number, note?: Maybe<{ message: string, source: { author: string, time: Date, requester: string } }>, issues?: Maybe<Array<Maybe<{ issueKey?: Maybe<string>, url?: Maybe<string>, source: { author: string, time: Date, requester: string } }>>>, suspectedIssues?: Maybe<Array<Maybe<{ issueKey?: Maybe<string>, url?: Maybe<string>, source: { author: string, time: Date, requester: string } }>>> }> }> };

export type PatchesPagePatchesFragment = { filteredPatchCount: number, patches: Array<{ id: string, projectID: string, description: string, status: string, createTime?: Maybe<Date>, commitQueuePosition?: Maybe<number>, canEnqueueToCommitQueue: boolean, builds: Array<{ id: string, buildVariant: string, status: string }> }> };
...
export type AbortTaskMutation = { abortTask: { id: string, execution: number } };
...
export type ClearMySubscriptionsMutationVariables = Exact<{ [key: string]: never; }>;
...
export type CreatePublicKeyMutation = { createPublicKey: Array<{ key: string, name: string }> };
...
export type EditSpawnHostMutation = { editSpawnHost: { id: string, displayName?: Maybe<string>, status: string, instanceType?: Maybe<string>, noExpiration: boolean, expiration?: Maybe<Date>, instanceTags: Array<{ key: string, value: string, canBeModified: boolean }>, volumes: Array<{ displayName: string, id: string }> } };
...
export type RemoveItemFromCommitQueueMutation = { removeItemFromCommitQueue?: Maybe<string> };
...
export type RemovePublicKeyMutation = { removePublicKey: Array<{ key: string, name: string }> };
...
export type RestartTaskMutation = { restartTask: { id: string, execution: number, status: string, latestExecution: number } };
...
export type SchedulePatchMutation = { schedulePatch: { id: string, activated: boolean, version: string, description: string, status: string, tasks: Array<string>, variants: Array<string>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>>, parameters: Array<{ key: string, value: string }> } };
...
export type ScheduleTaskMutation = { scheduleTask: { id: string, execution: number } };
...
export type SetTaskPriorityMutation = { setTaskPriority: { id: string, execution: number, priority?: Maybe<number> } };
...
export type UnschedulePatchTasksMutation = { unschedulePatchTasks?: Maybe<string> };
...
export type UnscheduleTaskMutation = { unscheduleTask: { id: string, execution: number } };
...
export type UpdatePublicKeyMutation = { updatePublicKey: Array<{ key: string, name: string }> };
...
export type UpdateSpawnHostStatusMutation = { updateSpawnHostStatus: { id: string, status: string } };
...
export type DistroTaskQueueQuery = { distroTaskQueue: Array<{ id: string, expectedDuration: number, requester: TaskQueueItemType, displayName: string, project: string, buildVariant: string, priority: number, version: string }> };
...
export type BuildBaronQuery = { buildBaron: { buildBaronConfigured: boolean, searchReturnInfo?: Maybe<{ search: string, source: string, featuresURL: string, issues: Array<{ key: string, fields: { summary: string, assigneeDisplayName?: Maybe<string>, resolutionName?: Maybe<string>, created: string, updated: string, status: { id: string, name: string } } }> }> } };

export type ClientConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type ClientConfigQuery = { clientConfig?: Maybe<{ latestRevision?: Maybe<string>, clientBinaries?: Maybe<Array<{ os?: Maybe<string>, displayName?: Maybe<string>, url?: Maybe<string>, arch?: Maybe<string> }>> }> };
...
export type CodeChangesQuery = { patch: { id: string, moduleCodeChanges: Array<{ branchName: string, htmlLink: string, rawLink: string, fileDiffs: Array<{ fileName: string, additions: number, deletions: number, diffLink: string, description: string }> }> } };
...
export type CommitQueueQuery = { commitQueue: { projectId?: Maybe<string>, message?: Maybe<string>, owner?: Maybe<string>, repo?: Maybe<string>, queue?: Maybe<Array<{ issue?: Maybe<string>, enqueueTime?: Maybe<Date>, patch?: Maybe<{ id: string, author: string, description: string, moduleCodeChanges: Array<{ rawLink: string, branchName: string, htmlLink: string, fileDiffs: Array<{ description: string, fileName: string, additions: number, deletions: number, diffLink: string }> }> }> }>> } };
...
export type GetCreatedTicketsQuery = { bbGetCreatedTickets: Array<{ key: string, fields: { summary: string, assigneeDisplayName?: Maybe<string>, resolutionName?: Maybe<string>, created: string, updated: string, status: { id: string, name: string } } }> };
...
export type DistrosQuery = { distros: Array<Maybe<{ name?: Maybe<string>, isVirtualWorkStation: boolean }>> };
...
export type HostEventsQuery = { hostEvents: { count: number, eventLogEntries: Array<{ id: string, resourceType: string, processedAt: Date, timestamp?: Maybe<Date>, eventType?: Maybe<string>, resourceId: string, data: { agentRevision: string, agentBuild: string, oldStatus: string, newStatus: string, logs: string, hostname: string, provisioningMethod: string, taskId: string, taskPid: string, taskStatus: string, execution: string, monitorOp: string, user: string, successful: boolean, duration: number } }> } };
...
export type MyHostsQuery = { myHosts: Array<{ expiration?: Maybe<Date>, hostUrl: string, homeVolumeID?: Maybe<string>, id: string, instanceType?: Maybe<string>, noExpiration: boolean, provider: string, status: string, startedBy: string, tag: string, user?: Maybe<string>, uptime?: Maybe<Date>, displayName?: Maybe<string>, availabilityZone?: Maybe<string>, distro?: Maybe<{ isVirtualWorkStation?: Maybe<boolean>, id?: Maybe<string>, user?: Maybe<string>, workDir?: Maybe<string>, isWindows?: Maybe<boolean> }>, instanceTags: Array<{ key: string, value: string, canBeModified: boolean }>, volumes: Array<{ displayName: string, id: string }> }> };

export type MyVolumesQueryVariables = Exact<{ [key: string]: never; }>;


export type MyVolumesQuery = { myVolumes: Array<{ id: string, displayName: string, createdBy: string, type: string, availabilityZone: string, size: number, expiration?: Maybe<Date>, deviceName?: Maybe<string>, hostID: string, noExpiration: boolean, homeVolume: boolean, creationTime?: Maybe<Date>, host?: Maybe<{ displayName?: Maybe<string>, id: string }> }> };
...
export type PatchBuildVariantsQuery = { patchBuildVariants: Array<{ variant: string, displayName: string, tasks?: Maybe<Array<Maybe<{ id: string, name: string, status: string, baseStatus?: Maybe<string> }>>> }> };
...
export type GetPatchTaskStatusesQuery = { patch: { id: string, taskStatuses: Array<string>, baseTaskStatuses: Array<string> } };
...
export type PatchTasksQuery = { patchTasks: { count: number, tasks: Array<{ id: string, status: string, baseStatus?: Maybe<string>, displayName: string, buildVariant: string, blocked: boolean, executionTasksFull?: Maybe<Array<{ id: string, execution: number, displayName: string, status: string, buildVariant: string, baseStatus?: Maybe<string> }>> }> } };

export type ProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectsQuery = { projects: { favorites: Array<{ identifier: string, repo: string, owner: string, displayName: string }>, otherProjects: Array<{ name: string, projects: Array<{ identifier: string, repo: string, owner: string, displayName: string }> }> } };

export type GetMyPublicKeysQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyPublicKeysQuery = { myPublicKeys: Array<{ name: string, key: string }> };

export type GetSpruceConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSpruceConfigQuery = { spruceConfig?: Maybe<{ bannerTheme?: Maybe<string>, banner?: Maybe<string>, ui?: Maybe<{ userVoice?: Maybe<string> }>, jira?: Maybe<{ host?: Maybe<string> }>, providers?: Maybe<{ aws?: Maybe<{ maxVolumeSizePerUser?: Maybe<number> }> }>, spawnHost: { spawnHostsPerUser: number, unexpirableHostsPerUser: number, unexpirableVolumesPerUser: number } }> };
...
export type GetTaskAllExecutionsQuery = { taskAllExecutions: Array<{ id: string, execution: number, status: string, ingestTime?: Maybe<Date>, activatedTime?: Maybe<Date> }> };
...
export type TaskFilesQuery = { taskFiles: { fileCount: number, groupedFiles: Array<{ taskName?: Maybe<string>, files?: Maybe<Array<{ name: string, link: string }>> }> } };
...
export type EventLogsQuery = { taskLogs: { eventLogs: Array<{ timestamp?: Maybe<Date>, eventType?: Maybe<string>, data: { hostId?: Maybe<string>, jiraIssue?: Maybe<string>, jiraLink?: Maybe<string>, priority?: Maybe<number>, status?: Maybe<string>, timestamp?: Maybe<Date>, userId?: Maybe<string> } }> } };
...
export type TaskTestsQuery = { taskTests: { filteredTestCount: number, totalTestCount: number, testResults: Array<{ id: string, status: string, baseStatus?: Maybe<string>, testFile: string, duration?: Maybe<number>, logs: { htmlDisplayURL?: Maybe<string>, rawDisplayURL?: Maybe<string> } }> } };
...
export type GetTaskQuery = { taskFiles: { fileCount: number }, task?: Maybe<{ id: string, execution: number, activatedBy?: Maybe<string>, buildVariant: string, ingestTime?: Maybe<Date>, estimatedStart?: Maybe<number>, displayName: string, finishTime?: Maybe<Date>, hostId?: Maybe<string>, projectId: string, patchNumber?: Maybe<number>, startTime?: Maybe<Date>, status: string, timeTaken?: Maybe<number>, version: string, revision?: Maybe<string>, totalTestCount: number, failedTestCount: number, spawnHostLink?: Maybe<string>, priority?: Maybe<number>, canRestart: boolean, canAbort: boolean, canSchedule: boolean, canUnschedule: boolean, canSetPriority: boolean, ami?: Maybe<string>, distroId: string, latestExecution: number, blocked: boolean, generatedBy?: Maybe<string>, generatedByName?: Maybe<string>, isPerfPluginEnabled: boolean, minQueuePosition: number, canModifyAnnotation: boolean, baseTaskMetadata?: Maybe<{ baseTaskDuration?: Maybe<number>, baseTaskLink: string }>, patchMetadata: { author: string, patchID: string }, reliesOn: Array<{ buildVariant: string, metStatus: MetStatus, name: string, requiredStatus: RequiredStatus, uiLink: string }>, logs: { allLogLink?: Maybe<string>, agentLogLink?: Maybe<string>, systemLogLink?: Maybe<string>, taskLogLink?: Maybe<string>, eventLogLink?: Maybe<string> }, details?: Maybe<{ oomTracker: { detected: boolean, pids?: Maybe<Array<Maybe<number>>> } }>, annotation?: Maybe<{ id: string, taskId: string, taskExecution: number, note?: Maybe<{ message: string, source: { author: string, time: Date, requester: string } }>, issues?: Maybe<Array<Maybe<{ issueKey?: Maybe<string>, url?: Maybe<string>, source: { author: string, time: Date, requester: string }, jiraTicket?: Maybe<{ key: string, fields: { summary: string, assigneeDisplayName?: Maybe<string>, resolutionName?: Maybe<string>, created: string, updated: string, assignedTeam?: Maybe<string>, status: { id: string, name: string } } }> }>>>, suspectedIssues?: Maybe<Array<Maybe<{ issueKey?: Maybe<string>, url?: Maybe<string>, source: { author: string, time: Date, requester: string }, jiraTicket?: Maybe<{ key: string, fields: { summary: string, assigneeDisplayName?: Maybe<string>, resolutionName?: Maybe<string>, created: string, updated: string, assignedTeam?: Maybe<string>, status: { id: string, name: string } } }> }>>> }> }> };

export type GetUserConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserConfigQuery = { userConfig?: Maybe<{ api_key: string, api_server_host: string, ui_server_host: string, user: string }> };

export type GetUserSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserSettingsQuery = { userSettings?: Maybe<{ timezone?: Maybe<string>, region?: Maybe<string>, slackUsername?: Maybe<string>, notifications?: Maybe<{ buildBreak?: Maybe<string>, commitQueue?: Maybe<string>, patchFinish?: Maybe<string>, patchFirstFailure?: Maybe<string>, spawnHostExpiration?: Maybe<string>, spawnHostOutcome?: Maybe<string> }>, githubUser?: Maybe<{ lastKnownAs?: Maybe<string> }>, useSpruceOptions?: Maybe<{ hasUsedSpruceBefore?: Maybe<boolean>, spruceV1?: Maybe<boolean> }> }> };

export type GetUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserQuery = { user: { userId: string, displayName: string, emailAddress: string } };
...
export type GetOtherUserQuery = { otherUser: { userId: string, displayName: string }, currentUser: { userId: string } };
...
export type HostsQuery = { hosts: { filteredHostsCount?: Maybe<number>, totalHostsCount: number, hosts: Array<{ id: string, distroId?: Maybe<string>, status: string, startedBy: string, hostUrl: string, tag: string, totalIdleTime?: Maybe<number>, uptime?: Maybe<Date>, elapsed?: Maybe<Date>, provider: string, noExpiration: boolean, runningTask?: Maybe<{ id?: Maybe<string>, name?: Maybe<string> }> }> } };
...
export type PatchQuery = { patch: { id: string, description: string, projectID: string, githash: string, patchNumber: number, author: string, version: string, status: string, activated: boolean, alias: string, taskCount?: Maybe<number>, commitQueuePosition?: Maybe<number>, baseVersionID?: Maybe<string>, canEnqueueToCommitQueue: boolean, parameters: Array<{ key: string, value: string }>, duration?: Maybe<{ makespan?: Maybe<string>, timeTaken?: Maybe<string> }>, time?: Maybe<{ started?: Maybe<string>, submittedAt: string, finished?: Maybe<string> }>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>> } };
...
export type ConfigurePatchQuery = { patch: { id: string, description: string, author: string, alias: string, status: string, activated: boolean, commitQueuePosition?: Maybe<number>, time?: Maybe<{ submittedAt: string }>, project?: Maybe<{ tasks: Array<string>, variants: Array<{ name: string, displayName: string, tasks: Array<string> }> }>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>>, parameters: Array<{ key: string, value: string }> } };
...
export type ProjectPatchesQuery = { project: { id: string, displayName: string, patches: PatchesPagePatchesFragment } };

export type SpawnExpirationInfoQueryVariables = Exact<{ [key: string]: never; }>;


export type SpawnExpirationInfoQuery = { myHosts: Array<{ noExpiration: boolean, id: string }>, myVolumes: Array<{ noExpiration: boolean, id: string }> };
...
export type SubnetAvailabilityZonesQuery = { subnetAvailabilityZones: Array<string> };

export type TaskQueueDistrosQueryVariables = Exact<{ [key: string]: never; }>;


export type TaskQueueDistrosQuery = { taskQueueDistros: Array<{ id: string, queueCount: number }> };
...
export type UserPatchesQuery = { user: { userId: string, patches: PatchesPagePatchesFragment } };
