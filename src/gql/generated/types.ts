...
export type MyVolumesQuery = { myVolumes: Array<{ id: string, displayName: string, createdBy: string, type: string, availabilityZone: string, size: number, expiration?: Maybe<Date>, deviceName?: Maybe<string>, hostID: string, noExpiration: boolean, homeVolume: boolean }> };
...
export type TaskTestsQuery = { taskTests: { filteredTestCount: number, totalTestCount: number, testResults: Array<{ id: string, status: string, testFile: string, duration?: Maybe<number>, logs: { htmlDisplayURL?: Maybe<string>, rawDisplayURL?: Maybe<string> } }> } };
...
export type PatchQuery = { patch: { id: string, description: string, projectID: string, githash: string, patchNumber: number, author: string, version: string, status: string, activated: boolean, alias: string, taskCount?: Maybe<number>, commitQueuePosition?: Maybe<number>, baseVersionID?: Maybe<string>, canEnqueueToCommitQueue: boolean, duration?: Maybe<{ makespan?: Maybe<string>, timeTaken?: Maybe<string> }>, time?: Maybe<{ started?: Maybe<string>, submittedAt: string, finished?: Maybe<string> }>, variantsTasks: Array<Maybe<{ name: string, tasks: Array<string> }>> } };
