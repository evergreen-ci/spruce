...
export type CommitQueueQuery = { commitQueue: { projectId?: Maybe<string>, message?: Maybe<string>, queue?: Maybe<Array<{ issue?: Maybe<string>, enqueueTime?: Maybe<Date>, patch?: Maybe<{ id: string, author: string, description: string, moduleCodeChanges: Array<{ rawLink: string, branchName: string, htmlLink: string, fileDiffs: Array<{ fileName: string, additions: number, deletions: number, diffLink: string }> }> }> }>> } };
