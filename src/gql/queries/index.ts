...
import GET_PROJECT_SETTINGS_GENERAL from "./get-project-settings-general.graphql";
import GET_PROJECT_SETTINGS_USE_REPO from "./get-project-settings-use-repo.graphql";
